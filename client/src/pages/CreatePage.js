        ...
        <div className='card blue-grey darken-1'>
          <div className='card-content white-text'>
            ...
            <div>
              ...
              <div className='input-field'>
                <input
                  placeholder='Введите название сиквела'
                  id='sequel'
                  type='text'
                  name='sequel'
                  onChange={formHandler}
              ...
              <div className='input-field'>
                <input
                  placeholder='Введите название приквела'
                  id='prequel'
                  type='text'
                  name='prequel'
                  onChange={formHandler}
              ...
              <div className='input-field'>
                <input
                  placeholder='Введите имя файла картинки с расширением(.png, .jpg)'
                  id='img'
                  type='text'
                  name='img'
                  onChange={formHandler}
              ...
              <div className='input-field'>
                <input
                  placeholder='Введите колличество книг в магазине'
                  id='quantity'
                  type='text'
                  name='quantity'
                  onChange={formHandler}
